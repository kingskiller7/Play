    ...
    <div className="flex flex-col min-h-[100dvh]">
      <header className="px-4 lg:px-6 h-14 flex items-center">
        ...
        <nav className="ml-auto flex gap-4 sm:gap-6">
          ...
          <Link href="https://github.com/kingskiller7/Play" className="text-sm font-medium hover:underline underline-offset-4" prefetch={false}>
            GitHub
          </Link>
        </nav>
      </header>
      ...
      <main className="flex-1">
        <div className="container w-full py-12 md:py-24 lg:py-32 xl:py-48">
          <div className="flex flex-col items-center space-y-4 text-center">
            <div className="space-y-2">
              <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl lg:text-6xl/none">
                Next-gen Authentication System
